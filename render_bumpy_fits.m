...
for lf = 1:2
    for bump = 2:10
        for gloss = 2:10
            ...
            writetable(T,'/scratch/gk925/render_stimuli/bumpy_fitrender_Conditions.txt','Delimiter','\t')
            ...
            hints.recipeName = ['MeshD',num2str(bump),'G',num2str(gloss),'L',num2str(lf),'-' datetime];
            ...
            for renderer = {'Mitsuba'}
                ...
                montageName = sprintf('MeshD%sG%sL%s', num2str(bump), num2str(gloss), num2str(lf));
